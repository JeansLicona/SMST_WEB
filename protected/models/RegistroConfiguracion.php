...
class RegistroConfiguracion extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('fk_usuario, fecha_hora_registro, configuracion_cambiada, '.
                'valor_viejo, valor_nuevo', 'required'),
            ...
            array('id_registro, fk_usuario, fecha_hora_registro, '.
                'configuracion_cambiada, valor_viejo, valor_nuevo',
                'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('fecha_hora_registro',
            $this->fecha_hora_registro,true);
        $criteria->compare('configuracion_cambiada',
            $this->configuracion_cambiada,true);
