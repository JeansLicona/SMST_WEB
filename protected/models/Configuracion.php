...
class Configuracion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('frecuencia_balance_taxista', 'numerical', 'integerOnly'=>true),
			array('costo_solicitud', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('costo_solicitud, frecuencia_balance_taxista', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'frecuencia_balance_taxista' => 'Frecuencia de Envío del Estado de Cuenta del Taxista',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('frecuencia_balance_taxista',$this->frecuencia_balance_taxista);
